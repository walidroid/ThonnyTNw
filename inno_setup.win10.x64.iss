...
Source: "RefreshEnv.cmd"; DestDir: "{tmp}"; Flags: ignoreversion
Source: "depsx64\*.whl"; DestDir: "{tmp}\deps\"; Flags: ignoreversion
Source: "depsx64\*.tar.gz"; DestDir: "{tmp}\deps\"; Flags: ignoreversion
...
Filename: "cmd.exe"; Parameters: "/q /c mode 80,5 && title Installation de PyInstaller ... && {tmp}\RefreshEnv.cmd && ""{app}\python.exe"" -m pip install pyinstaller --upgrade --no-index --find-links {tmp}\deps --prefer-binary >> {tmp}\innosetup.log"; StatusMsg: "Installation de l'outil d'exportation EXE (PyInstaller) ..."
